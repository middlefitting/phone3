        ...
        >
            <v-row>
                <v-list-item class="d-flex" style="background-color: white;">
                    <h1 class="align-self-center ml-3">Phone</h1>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                <v-dialog v-model="openDialog" width="500">
                    <PhonePhone :offline="offline"  :isNew="true" :editMode="true" v-model="newValue" 
...
<script>
    ...
    import PhonePhone from './../PhonePhone.vue';
